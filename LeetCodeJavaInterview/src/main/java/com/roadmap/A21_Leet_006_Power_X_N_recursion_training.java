 ...
 * -104 <= xn <= 104
 */
public class A21_Leet_006_Power_X_N_recursion_training {

    public static void main(String[] args) {
        A21_Leet_006_Power_X_N_recursion_training leet = new A21_Leet_006_Power_X_N_recursion_training();
    ...
    private double pow(double base, int powerOf) {
        if (base == 1.0 || powerOf == 0) return 1.0;
        if (powerOf < 0) return 1.0 / pow(base, -powerOf);
        return base * pow(base, powerOf - 1);
    }
