 ...
 */
public class A15_Leet_006_Valid_Sudoku_easier {
    public static void main(String[] args) {
        A15_Leet_006_Valid_Sudoku_easier leet = new A15_Leet_006_Valid_Sudoku_easier();
    ...
    public boolean isValidSudoku(char[][] board) {
        ...
        for (int i = 0; i < 9; i++) {
            for(int j = 0; j < 9; j++){
                ...
                if(currentVal != '.'){
                    String keyRow = "row:["+i+"] -> "+currentVal;
                    String keyColum = "col:["+j+"] -> "+currentVal;
                    String keySqr = "box:["+i/3+"]["+j/3+"] -> "+currentVal;
                    if(seen.contains(keyRow) || seen.contains(keyColum) || seen.contains(keySqr)){
                        return false;
                    }
                    seen.add(keyRow);
                    seen.add(keyColum);
